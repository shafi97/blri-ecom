...
class RoleController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('permission.roles.index')->with('roles', $roles);
    }
    ...
    public function show(Role $role)
    {
        ...
        // return $permissions;
        return view('permission.roles.show', compact(['role','permissions','roles']));
    }
    ...
    public function edit(Request $request, Role $role)
    {
        ...
        if ($request->ajax()) {
            $modal = view('permission.roles.edit')->with('role', $role)->render();
