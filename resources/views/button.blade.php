@if ($type == 'ajax-edit')
    <button data-route="{{ $route }}" data-value="{{ $row->id }}" class='text-primary' onclick="ajaxEdit(this)"
        data-bs-placement="top" data-bs-toggle="tooltip" data-bs-original-title="@lang('app.edit')"
...
@if ($type == 'delete')
    <button data-route="{{ route($route . '.destroy', $row->id) }}" class='_delete text-danger' data-bs-placement="top"
...
@if ($type == 'ajax-delete')
    <button data-route="{{ $route }}" data-value="{{ $row->id }}"
        onclick="ajaxDelete(this, '{{ $src }}')" class='text-danger' data-bs-placement="top"
        data-bs-toggle="tooltip" data-bs-original-title="@lang('app.cannot-undo')" title='@lang('app.delete')'><i
